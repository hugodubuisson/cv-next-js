        ...
        <section className={`${styles.skills} ${secular_one.className}`}>
            ...
            <div className={styles.skillsGrid}>
                <div className={styles.skillCard}>
                    ...
                    <Image src="./images/html.svg" alt="HTML" width={64} height={64} className={styles.skillCardImage} loading="lazy" />
                </div>
                <div className={styles.skillCard}>
                    <h3 className={styles.skillCardTitle}>CSS</h3>
                    <Image src="./images/css-3.svg" alt="CSS" width={64} height={64} className={styles.skillCardImage} loading="lazy" />
                </div>
                <div className={styles.skillCard}>
